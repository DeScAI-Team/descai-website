...
const SnapshotsPanel = ({ className }: SnapshotsPanelProps) => {
  return (
    ...
    >
      <article className="relative w-full overflow-hidden rounded-[16px] border border-white/15 bg-[#141c3d]/95 p-6 text-center text-sm leading-relaxed text-white/80 shadow-[0_20px_50px_rgba(0,0,0,0.45)]">
